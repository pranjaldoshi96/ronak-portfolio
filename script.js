...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateElements = document.querySelectorAll('.credential-card, .timeline-item, .feature');
    ...
    // YouTube channel analytics (basic tracking)
    ...
    // Add hover effects to credential cards
    ...
    // Typing animation for hero title - disabled for HTML content
    const heroTitle = document.querySelector('.hero-title');
    if (heroTitle) {
        // Simple fade-in animation instead of typing for HTML content
    ...
    window.addEventListener('scroll', function() {
        ...
        if (parallaxElement) {
            ...
            parallaxElement.style.backgroundPosition = `center ${speed}px`;
        }
    });
